...
<tileset version="1.10" tiledversion="1.11.1" name="NPC Tileset" tilewidth="64" tileheight="64" tilecount="16" columns="4">
 <image source="../../../Sprites/Level Sprites/Legacy/NPC Tileset.png" width="256" height="256"/>
 <tile id="0">
  <properties>
   <property name="enemyType" value="BasicEnemy"/>
   <property name="relatedObject" value="Enemy"/>
