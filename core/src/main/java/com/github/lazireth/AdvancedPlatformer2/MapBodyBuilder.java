...
import com.github.lazireth.AdvancedPlatformer2.objects.Wall;
...
public class MapBodyBuilder {
    ...
    static float pixelsPerUnit = pixelsPerMeter;

    public static ArrayList<Body> buildShapes(TiledMap map, World world) {
