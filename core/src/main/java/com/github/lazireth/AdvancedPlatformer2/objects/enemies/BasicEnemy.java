...
import com.github.lazireth.AdvancedPlatformer2.Direction;
...
public class BasicEnemy extends Enemy {
    ...
    LevelMap levelMap;
    public BasicEnemy (TiledMapTileMapObject enemy, LevelMap levelMap) {
        myMapObject=enemy;
    ...
    public void update(float delta) {
        ...
        if(running){
            ...
            if(Math.abs(LevelMap.player.getXPosition()-body.getPosition().x)<18){
                running=true;
...
//            }
    ...
    private void addToWorld() {
        ...
        bodyDef.position.set(pixelsToMeters(myMapObject.getX()), pixelsToMeters(myMapObject.getY()));
