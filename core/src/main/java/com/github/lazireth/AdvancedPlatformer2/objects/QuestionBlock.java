...
public class QuestionBlock extends InteractableObject{
    ...
    LevelMap levelMap;
    public QuestionBlock(TiledMapTileMapObject questionBlock, LevelMap levelMap){
    ...
    private void makeSensor() {
        ...
        float x= pixelsToMeters(questionBlock.getX());
        float y= pixelsToMeters(questionBlock.getY());
